...
serve(async (req: Request) => {
    ...
    try {
        ...
        // envoyer un email à n'importe quelle adresse via notre compte Brevo.
        ...
        const htmlContent = `
                <div style="font-family: 'Segoe UI', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; border: 1px solid #e5e7eb; border-radius: 8px; padding: 40px; background-color: #ffffff;">
                    ...
                    <p>Nous vous remercions de la confiance que you portez à l'ONG DDB et vous prions d'agréer, l'expression de nos salutations distinguées.</p>
